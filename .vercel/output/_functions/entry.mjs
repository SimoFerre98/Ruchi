...
import { c as createExports, s as serverEntrypointModule } from './chunks/_@astrojs-ssr-adapter_BBQdQEoG.mjs';
import { manifest } from './manifest_Dt6aXiXe.mjs';

const serverIslandMap = new Map();;

const _page0 = () => import('./pages/_image.astro.mjs');
const _page1 = () => import('./pages/dashboard.astro.mjs');
const _page2 = () => import('./pages/event/_id_.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/event/[id].astro", _page2],
...
const _args = {
    "middlewareSecret": "bc929354-dc35-4b3b-9748-b87c2d94d2a7",
